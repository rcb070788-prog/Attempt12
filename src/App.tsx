...
import { useFinanceData } from './features/finance';
import { useFeatures, useActions } from './features/social';
import { useNavigation } from './hooks/useNavigation';
import { useTitleBarVisibility } from './hooks/useTitleBarVisibility';
...
export default function App() {
  ...
  const { user, profile, setProfile, setUser, sessionHydrated, signOut } = useAuth({
    onProfileNotFound,
    onVoterRemoved,
  });
  ...
  const { titleBarVisible, titleBarRef, isDesktop } = useTitleBarVisibility();
  ...
  return (
    ...
    <FeaturesContextProvider value={featuresContextValue}>
    <div
